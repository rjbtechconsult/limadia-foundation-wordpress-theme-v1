jQuery(function($) {
    ...
    THEMEMASCOT.initialize = {
        ...
        TM_loadBSParentModal: function() {
            ...
            if( ajaxLoadContent ) {
                $.ajax({
                    url: "/wp-content/themes/limadia-entity-foundation-v1/ajax-load/bootstrap-parent-modal.html",
        ...
        TM_demoSwitcher: function() {
            ...
            if( showSwitcher ) {
                $.ajax({
                    url: "/wp-content/themes/limadia-entity-foundation-v1/color-switcher/style-switcher.html",
                    success: function (data) { $('body').append(data); },
                    dataType: 'html'
                });
            }
